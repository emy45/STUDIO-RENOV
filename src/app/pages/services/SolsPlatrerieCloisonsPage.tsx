...
import dryWallImage from 'figma:asset/129ebbc2cbc6056afbdebfc226efb0fa4243ef7c.png';

export function SolsPlatrerieCloisonsPage() {
  ...
  const features = [
    'Pose de parquet massif et flottant',
    'Carrelage sol et mur',
    'Faïence pour cuisines et salles de bain',
    'Création de cloisons BA13',
    'Plâtrerie traditionnelle',
    'Isolation phonique et thermique',
  ];

  const gallery = [
    'https://images.unsplash.com/photo-1769736436809-eab3de70b175?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBwYXJxdWV0JTIwZmxvb3JpbmclMjBpbnRlcmlvcnxlbnwxfHx8fDE3NzQ1MTMyNDh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    'https://images.unsplash.com/photo-1693948568453-a3564f179a84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwYXJxdWV0JTIwd29vZCUyMGZsb29yaW5nJTIwaW5zdGFsbGF0aW9ufGVufDF8fHx8MTc3NDYxNzMxMXww&ixlib=rb-4.1.0&q=80&w=1080',
    dryWallImage,
  ];
    ...
    <div className="bg-[#0D0D0D]">
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            Sols, Plâtrerie & <span className="text-[#EFBF04]">Cloisons</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            style={{ fontFamily: 'Raleway, sans-serif' }}
          >
            Des revêtements de qualité et des cloisons sur mesure pour structurer vos espaces
          </motion.p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2
                ...
                style={{ fontFamily: 'Playfair Display, serif', fontWeight: 700 }}
              >
                Expertise en <span className="text-[#EFBF04]">Revêtements</span>
              </h2>
              <p
                className="text-white/70 mb-6 text-lg"
                style={{ fontFamily: 'Raleway, sans-serif' }}
              >
                Que vous recherchiez la chaleur du parquet, l'élégance du carrelage ou la praticité 
                de la faïence, nous maîtrisons tous les types de revêtements pour sublimer votre intérieur.
              </p>
              <p
                className="text-white/70 mb-6 text-lg"
                style={{ fontFamily: 'Raleway, sans-serif' }}
              >
                Notre savoir-faire en plâtrerie et création de cloisons nous permet de réagencer 
                vos espaces selon vos besoins, tout en assurant une isolation optimale.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
